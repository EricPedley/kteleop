...
const options = {
  key: fs.readFileSync('./10.33.80.4+3-key.pem'),
  cert: fs.readFileSync('./10.33.80.4+3.pem')
};
...
server.listen(PORT, '0.0.0.0', () => {
  console.log(`HTTPS proxy server running on https://10.33.80.4`);
...
## 6. Access your site
Navigate to: `https://10.33.80.4` (replace with your actual IP)
...
├── https-proxy.js
├── 10.33.80.4+3.pem
└── 10.33.80.4+3-key.pem
```

## Notes
- Replace `10.33.80.4` with your actual Raspberry Pi IP address
